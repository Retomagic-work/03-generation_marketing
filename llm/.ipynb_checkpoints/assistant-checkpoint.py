...
class DigitalAssistant:
    def __init__(self, translator_model_ru_to_en, translator_model_en_to_ru, device=0):
        ...
        self.assistant_model = AutoModelForCausalLM.from_pretrained("TheBloke/Mistral-7B-Instruct-v0.2-GGUF", model_file="mistral-7b-instruct-v0.2.Q4_K_M.gguf", model_type="mistral", gpu_layers=50, max_new_tokens = 1000, context_length = 6000)
        self.device = device
